...
const buildVersion = (
  ...
  return {
    ...
    // בשלב 1 של ה-rules לקוח ישן לא כותב `updatedBy`, והשדה נשאר עם הכותב
    // הקודם. לכן עד שלב 2 (B6b) הייחוס יכול להיות של הכותב הקודם, ו"לא
    // ידוע" מופיע רק בפתקים שאף לקוח חדש לא כתב בהם.
