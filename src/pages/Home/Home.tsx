          ...
          <div className="flex items-center justify-between gap-3 mb-3">
            <div className="flex items-center gap-3 min-w-0 flex-1">
              <div className="flex flex-col">
                ...
                <span className="text-[8px] sm:text-[10px] text-white/60">v1.0.5</span>
              </div>
              ...
              <div className="flex-1 max-w-md hidden sm:block">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2 pr-10 rounded-xl bg-white/20 backdrop-blur-sm border border-white/30 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all"
                  />
          ...
          <div className="sm:hidden">
            <div className="relative">
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full px-4 py-2 pr-10 rounded-xl bg-white/20 backdrop-blur-sm border border-white/30 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all text-sm"
              />
              <span className="absolute right-3 top-1/2 -translate-y-1/2 text-white/70">🔍</span>
            </div>
          </div>
